...
public class TwoPlayerMainGameP2 extends Activity {

    public static final String KEY_RESTORE = "key_restore";
    public static final String PREF_RESTORE = "pref_restore";

    TwoPlayerGameFragmentP2 mGameFragment;
    ...
    boolean mute = false;
    int score = 0;
    ValueEventListener player2Listener;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        requestWindowFeature(Window.FEATURE_CUSTOM_TITLE);
        setContentView(R.layout.two_player_p2);
        ...
        mGameFragment = (TwoPlayerGameFragmentP2) getFragmentManager()
    ...
    public void endTurn2(View view){
            ...
            mDatabase.child("players").child("player1")
                    .runTransaction(new Transaction.Handler() {
                        ...
                        public Transaction.Result doTransaction(MutableData mutableData) {
                            ...
                            u.setStatusMessage("Player2 found a word. Find the purple cell");
    ...
    public void submitWords() {
        ...
        TextView words = (TextView) findViewById(R.id.statusMessage2);
        TextView show = (TextView) findViewById(R.id.playMessage2);
        ...
        Button endturn = (Button) findViewById(R.id.end_turn2);
        Button mute = (Button) findViewById(R.id.mute_2p_2);
    ...
    private void calculateScore(List<String> correctWords) {
        ...
        mDatabase.child("players").child("player1").addValueEventListener(scoreListener);
    }

    private void reportWinner(String p1Score, int thisScore, ValueEventListener scoreListener){
        TextView win = (TextView) findViewById(R.id.winner_2);
        if(thisScore > Integer.valueOf(p1Score)){
            win.setText("You win");
        }
        else {
            win.setText("You lose. Better luck next time");
        }
        mDatabase.child("players").child("player1").removeEventListener(scoreListener);
    }
    ...
    public void muteMusic(View view) {
        Button b = (Button) findViewById(R.id.mute_2p_2);
        if (mute) {
            b.setText("Mute");
            mute = false;
    ...
    public void hideButtons(ValueEventListener valueEventListener){
        Button endTurn = (Button) findViewById(R.id.end_turn2);
        Button mute = (Button) findViewById(R.id.mute_2p_2);
        Button quit = (Button) findViewById(R.id.quit_2p_2);
    ...
    private void updateTextViews(String playMessage, String statusMessage) {
        TextView pm = (TextView) findViewById(R.id.playMessage2);
        TextView sm = (TextView) findViewById(R.id.statusMessage2);
